/**
 * SBOM Play - Common Utilities
 * 
 * This file consolidates all shared utility functions used across the application.
 * It should be loaded first (after Bootstrap) on all pages.
 * 
 * Contents:
 ...
 * - Finding utilities (getFindingName, getFindingDescription)
 * - Repository formatting (formatRepoHTML, formatRepoListItem, generateRepoListHTML)
 */

console.log('📦 SBOM Play common.js loaded');
 ...
 * Reads timeout from localStorage (default: 10000ms)
...
// Make network utilities globally available for services
